...
available_book_2_recipe = Recipe(Book, status=BookStatusType.AVAILABLE.value)
available_book_3_recipe = Recipe(Book, status=BookStatusType.AVAILABLE.value)
rented_book_1_recipe = Recipe(Book, status=BookStatusType.RENTED.value)
rented_book_2_recipe = Recipe(Book, status=BookStatusType.RENTED.value)
