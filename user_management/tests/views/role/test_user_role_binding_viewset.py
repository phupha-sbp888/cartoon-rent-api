...
class TestUserRoleBindingViewSet(APITestCase):
    ...
    def setUpTestData(cls) -> None:
        ...
        normal_user_1: User = normal_user_recipe.make()
        normal_user_2: User = normal_user_recipe.make()
        cls.role_binding_user_1: UserRoleBinding = Recipe(
            UserRoleBinding, user_id=normal_user_1, role_id=existing_role_1
        ).make()
        cls.role_binding_user_2: UserRoleBinding = Recipe(
            UserRoleBinding, user_id=normal_user_2, role_id=existing_role_1
        ).make()
    ...
    def test_list_user_role_binding_with_admin_user(self) -> None:
        ...
        expected_result: List[UserRoleBindingSerializer] = [
            UserRoleBindingSerializer(self.role_binding_user_2).data,
            UserRoleBindingSerializer(self.role_binding_user_1).data,
        ]
    ...
    def test_retrieve_non_existing_role_binding(self) -> None:
        ...
        url: str = reverse(
            "roles:retrieve-role-binding",
            args=[self.role_binding_user_1.role_binding_id + self.role_binding_user_2.role_binding_id + 1],
        )
        response: Response = self.client.get(url)
        self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
    ...
    def test_assigning_role_to_user_with_missing_role_id(self) -> None:
        ...
        url: str = reverse("roles:assign-roles")
        invalid_role_assign_input: Dict[str, int] = {"user_id": self.normal_user_1.user_id}
    ...
    def test_update_role_binding_with_missing_role_id(self) -> None:
        ...
        url: str = reverse("roles:update-role-binding", args=[self.role_binding_user_1.role_binding_id])
        invalid_role_binding_update_date: Dict[str, int] = {"user_id": self.normal_user_1.user_id}
